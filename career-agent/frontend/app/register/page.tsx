  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[hsl(var(--background))]">
      <div className="w-full max-w-md p-8 rounded-2xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] shadow-sm">
        ...
        <p className="text-sm text-[hsl(var(--muted-foreground))] mb-6">Join Career Agent — free for students</p>
        ...
        <p className="mt-4 text-center text-sm text-[hsl(var(--muted-foreground))]">
          Already have an account? <Link href="/login" className="text-[hsl(var(--primary))] hover:underline">Sign in</Link>
        </p>
      </div>
    </div>
  );
